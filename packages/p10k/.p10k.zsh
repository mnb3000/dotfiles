# Generated by Powerlevel10k configuration wizard on 2025-01-20 at 20:42 EET.
...
# 2 lines, dotted, right frame, white-ornaments, sparse, many icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%5F'  # yellow foreground
